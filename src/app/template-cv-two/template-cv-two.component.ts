...
@Component({
  selector: 'app-template-cv-two',
  templateUrl: './template-cv-two.component.html',
  styleUrls: ['./template-cv-two.component.css']
})
export class TemplateCvTwoComponent implements OnInit {
