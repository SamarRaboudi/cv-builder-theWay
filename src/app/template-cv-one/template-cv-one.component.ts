...
@Component({
  selector: 'app-template-cv-one',
  templateUrl: './template-cv-one.component.html',
  styleUrls: ['./template-cv-one.component.css']
})
export class TemplateCvOneComponent implements OnInit {
  @Input() data:any={};
